...
export default function SalesStudents() {
  ...
  if (isLoading) {
    return (
      <PageLayout title="Students" subtitle="View and manage all students in the system">
  ...
  return (
    <PageLayout 
      title="Students" 
      subtitle="View and manage all students in the system"
    >
      <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl rounded-2xl overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        ...
        <CardContent className="p-6">
          {students && students.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-blue-700 font-medium text-lg">No students found</p>
              <p className="text-sm text-blue-500 mt-1">Students will appear here once they are registered</p>
            </div>
          ) : (
